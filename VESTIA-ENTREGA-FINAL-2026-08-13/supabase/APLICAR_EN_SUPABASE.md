...
El proyecto vinculado ya tiene aplicadas las migraciones `001` a `019` y las funciones `create-business` y `create-user` están activas. No vuelvas a pegar el SQL consolidado sobre esa misma base.
...
4. Ejecutar las migraciones con `db push`, o pegar una sola vez `VESTIA_BASE_DATOS_COMPLETA_2026-08-13.sql` en SQL Editor.
