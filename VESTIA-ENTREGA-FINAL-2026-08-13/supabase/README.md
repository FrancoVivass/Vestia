...
Las migraciones `001` a `019` son la fuente de verdad. El archivo `VESTIA_BASE_DATOS_COMPLETA_2026-08-13.sql` las reúne para instalar un proyecto Supabase nuevo. En el proyecto vinculado actual ya están aplicadas.
