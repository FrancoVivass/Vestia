...
Las migraciones `001` a `019` están en `supabase/migrations`. El SQL consolidado se encuentra en `supabase/VESTIA_BASE_DATOS_COMPLETA_2026-08-13.sql`. Las instrucciones completas están en `supabase/APLICAR_EN_SUPABASE.md`.
