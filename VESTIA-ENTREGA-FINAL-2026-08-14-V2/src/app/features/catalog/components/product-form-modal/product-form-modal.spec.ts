...
describe('ProductFormModalComponent', () => {
  ...
  it('advances through the three product screens and emits a valid product', () => {
    const fixture = TestBed.createComponent(ProductFormModalComponent);
    const component = fixture.componentInstance;
    fixture.componentRef.setInput('open', true);
    fixture.componentRef.setInput('categories', [{ id: 'category', name: 'Remeras' }]);
    fixture.componentRef.setInput('brands', [{ id: 'brand', name: 'VESTIA' }]);
  ...
  it('generates SKU, internal code and barcode', () => {
    ...
    expect(component.form.controls.barcode.value).toMatch(/^20\d{10}$/);
  });
});
