...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'duenos-estadisticas', loadComponent:()=>import('./features/owners/pages/owners-stats-page/owners-stats-page').then(m=>m.OwnersStatsPageComponent), canActivate:[roleGuard], data:{roles:['OWNER']}, title:'VESTIA | Estadísticas de Dueños' },
