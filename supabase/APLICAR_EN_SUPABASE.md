...
El proyecto vinculado ya tiene aplicadas las migraciones `001` a `023` y las funciones `create-business` y `create-user` están activas. No vuelvas a pegar el SQL consolidado sobre esa misma base.
...
- `021`: etiquetas automáticas CODE128, sincronización por variante y registro de impresión térmica.
- `022`: borrado seguro de productos con conservación de operaciones y auditoría.
- `023`: stock inicial o adicional por variante, creación automática de dueño principal, lotes, saldos y movimientos auditados.
