...
El proyecto vinculado ya tiene aplicadas las migraciones `001` a `021` y las funciones `create-business` y `create-user` están activas. No vuelvas a pegar el SQL consolidado sobre esa misma base.
