...
- Productos en un asistente modal de tres pantallas, con imágenes, variantes, talles, colores, SKU, código interno y barras.
...
- Etiquetas CODE128 creadas automáticamente por variante e impresión térmica configurable para comandera.
...
Las migraciones `001` a `021` están en `supabase/migrations`. El SQL consolidado se encuentra en `supabase/VESTIA_BASE_DATOS_COMPLETA_2026-08-14.sql`. Las instrucciones completas están en `supabase/APLICAR_EN_SUPABASE.md`.
